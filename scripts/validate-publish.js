...
function validateProjectPostmortemContracts(errors) {
  ...
  const requiredSnippets = [
    ...
    ['cc-act SKILL.md', act, 'Redaction Guard'],
    ['cc-act PROJECT_POSTMORTEM_TEMPLATE.md', fs.readFileSync(path.join(ROOT, '.claude/skills/cc-act/assets/PROJECT_POSTMORTEM_TEMPLATE.md'), 'utf8'), '## Redaction Guard'],
