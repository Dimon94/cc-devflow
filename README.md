...
| `cc-review` | Complex plans, investigations, diffs, complexity reports, optimization hotspots, or harsh structural quality reviews need optional deep review before implementation or verification | plan findings in `task.md`; implementation findings and repair options in the response |
