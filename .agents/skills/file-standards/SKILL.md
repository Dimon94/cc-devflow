...
- Validated by: `.Codex/scripts/check-prerequisites.sh`
...
- Format defined in: `.Codex/docs/templates/TASKS_TEMPLATE.md`
...
### Source
- Created by: `.Codex/scripts/create-requirement.sh`
- Template: `.Codex/docs/templates/` 目录
...
- Parsed by: `.Codex/scripts/check-prerequisites.sh`, `.Codex/scripts/generate-status-report.sh`
...
### .Codex/tsc-cache/ (PostToolUse tracking)
```
.Codex/tsc-cache/
└── {session_id}/
...
- ❌ Complete template contents (that's in `.Codex/docs/templates/`)
