...
**Full Constitution**: `.Codex/rules/project-constitution.md` v2.0.0
...
**For Details**: See `.Codex/rules/project-constitution.md#article-i-quality-first-质量至上`
...
**For Details**: See `.Codex/rules/project-constitution.md#article-ii-architectural-consistency-架构一致性`
...
**For Details**: See `.Codex/rules/project-constitution.md#article-iii-security-first-安全优先`
...
**For Details**: See `.Codex/rules/project-constitution.md#article-iv-performance-accountability-性能责任`
...
**For Details**: See `.Codex/rules/project-constitution.md#article-v-maintainability-可维护性`
...
**For Details**: See `.Codex/rules/project-constitution.md#article-vi-test-first-development-测试优先开发`
...
**For Details**: See `.Codex/rules/project-constitution.md#article-vii-simplicity-gate-简单性闸门`
...
**For Details**: See `.Codex/rules/project-constitution.md#article-viii-anti-abstraction-反抽象化`
...
**For Details**: See `.Codex/rules/project-constitution.md#article-ix-integration-first-testing-集成优先测试`
...
**For Details**: See `.Codex/rules/project-constitution.md#article-x-requirement-boundary-需求边界`
...
**For Details**: See [planner agent](.Codex/agents/planner.md) Phase -1 Gates Enforcement Sequence
