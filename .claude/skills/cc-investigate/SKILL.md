...
exit_criteria:
  ...
  - "planning/analysis.md, planning/tasks.md, and change-meta.json record the canonical work branch or the explicit reason no branch mutation was valid."
...
4. 在 `planning/analysis.md`、`planning/tasks.md` 和 `change-meta.json` 记录 work branch。没有记录 work branch 的 repair handoff 不能进入 `cc-do`。
