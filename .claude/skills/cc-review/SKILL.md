...
exit_criteria:
  ...
  - If hardening specialists are selected, every selected specialist is checked, skipped with reason, or blocked, and findings include the reviewed surface map, violated security, observability, release, or test-strategy control, evidence, proof path, risk gate, and residual risk. Observability findings name the unanswered incident question and safe signal shape; release-readiness findings name gate status plus rollback or watch path.
