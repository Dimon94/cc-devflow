...
7. Complexity hotspot / report review: `references/complexity-optimization-playbook.md` and `references/complexity-report-template.md`
8. Hardening specialist review: `references/hardening-specialists.md`
...
6. Structural quality / code-judo: 是否能通过薄入口、小文件、feature-owned 模块、纯领域逻辑、集中契约、兼容迁移、真实视口 QA、重新归位所有权、删除特殊分支、收紧类型边界、复用 canonical helper、拆分超大文件、合并重复路径或原子化更新，让行为不变但结构明显更简单。
