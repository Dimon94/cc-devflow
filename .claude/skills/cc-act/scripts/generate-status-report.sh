...

{
  ...
  [[ -f "$handoff_dir/release-note.md" ]] && echo "- Legacy release note: present; fold into pr-brief.md on next render"
  [[ -f "$handoff_dir/resume-index.md" ]] && echo "- Legacy resume index: present; fold into pr-brief.md on next render"
  [[ -f "$handoff_dir/doc-sync-report.md" ]] && echo "- Legacy doc sync report: present; fold into pr-brief.md on next render"
}
