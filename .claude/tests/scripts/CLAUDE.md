# scripts/
> L2 | 父级: /Users/dimon/.codex/worktrees/a474/cc-devflow/.claude/tests/CLAUDE.md
>
...
test_workflow_skill_alignment.sh: workflow schema / skill 目录 / `.claude` 地图同构测试，守住 roadmap + PDCA 主链、无默认注入、无项目级混入。
