...
- `cc-act` writes exactly one final handoff file: `handoff/pr-brief.md`; release notes, resume entry, and doc sync status live as sections inside that file
