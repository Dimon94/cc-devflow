...
- `cc-act` carries release-readiness gates into PR or handoff output: local checks, config/env, migrations/data, deploy/health, smoke/cleanup, rollback, and watch items.
